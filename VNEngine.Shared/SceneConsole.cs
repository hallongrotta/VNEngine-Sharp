...
namespace VNEngine
{
    ...
    public class SceneConsole
    {
        ...
        public Dictionary<string, (string command, string key)> shortcuts;

        public SkinBase skinDefault;
        ...
        public (string msg, object func_param, bool single_op)? warning_param;
        ...
        public virtual void show_blocking_message(string text = "...")
        {
            this.funcLockedText = text;
            this.isFuncLocked = true;
        }

        public virtual void hide_blocking_message(object game = null)
        {
            this.isFuncLocked = false;
        }

        public virtual void show_blocking_message_time_sc(string text = "...", float duration = 3f)
        {
        ...
        // other
        public virtual void updateSceneStrings()
        {
            this.scene_strings = new List<string>();
        ...
        // ---------- ministates ------------
        public virtual void addSelectedAutoShow(string param)
        {
        ...
        public virtual void delSelectedAutoShow()
        {
            // get list of sel objs
            var arSel = this.get_selected_objs();
            if (arSel.Count == 0)
        ...
        public virtual void addSelectedMini()
        {
            // find mini
            ...
            {
                //fldObj = folder_add_child(fldName,JsonSerializer.Serialize(objSave))
                Utils.folder_add_child(fldName, JsonSerializer.Serialize(new Dictionary<object, object> {
                    {
                        k,
                        objSave[k]}}));
            }
            ...
            //
            // fldObj = HSNeoOCIFolder.add(JsonSerializer.Serialize(objSave))
            // fldObj.set_parent(fldName)
            this.mininewid = "";
        }

        public virtual int find_item_in_objlist(ObjectCtrlInfo obj)
        {
        ...
        public virtual List<HSNeoOCI> get_selected_objs()
        {
        ...
        // Add stuff
        public virtual void addScene(bool insert = false)
        {
            if (insert == false)
            {
        ...
        public virtual void getSceneCamString()
        {
        ...
        public virtual void changeSceneCam(object param)
        {
            changeSceneCam((string)param);
        }

        public virtual void changeSceneCam()
        {
            changeSceneCam(task: "");
        }

        public virtual void changeSceneCam(string task = "")
        {
        ...
        public virtual void setCamera(bool isAnimated)
        {
        ...
        public virtual void addAutoWithMsg()
        {
            this.addAuto();
            this.show_blocking_message_time_sc("Scene added!", 2.0f);
        }

        public virtual void addAuto(bool insert = false, bool addsc = true, bool allbase = true)
        {
            if (addsc == true)
            {
        ...
        public virtual void removeScene(object param)
        {
            removeScene();
        }
        ...
        public virtual void setSceneState()
        {
            setSceneState(this.cur_index);
        }

        public virtual void setSceneState(int index)
        {
            var curscene = this.block[index];
            curscene.setSceneState(this.game);
        }

        public virtual void copySelectedStatusToTracking(List<string> exclude)
        {
        ...
        public virtual void copySelectedStatus()
        {
            var elem = HSNeoOCI.create_from_selected();
            if (elem is HSNeoOCIChar chara)
            {
        ...
        public virtual void pasteSelectedStatus()
        {
            var elem = HSNeoOCI.create_from_selected();
            if (elem is HSNeoOCIChar chara)
            {
        ...
        public virtual void copySelectedStatus2()
        {
            var elem = HSNeoOCI.create_from_selected();
            if (elem is HSNeoOCIChar chara)
            {
        ...
        public virtual void pasteSelectedStatus2()
        {
            var elem = HSNeoOCI.create_from_selected();
            if (elem is HSNeoOCIChar chara)
            {
        ...
        public virtual bool isSysTracking()
        {
            if (this.block.Count > 0)
            {
        ...
        public virtual void addSysTracking()
        {
            if (this.block.Count > 0)
            {
        ...
        public virtual void delSysTracking()
        {
            foreach (var i in Enumerable.Range(0, this.block.Count))
            {
        ...
        public virtual void addSelectedToTrack()
        {
            Scene scene;
        ...
        public virtual void changeSelTrackID(string toId)
        {
            if (toId == "")
            {
        ...
        public virtual void delSelectedFromTrack()
        {
            var elem = HSNeoOCI.create_from_selected();
            if (elem == null)
            {
        ...
        public virtual void delActorFromTrack(string actid)
        {
            if (actid != "")
            {
                // we found this char
        ...
        public virtual void changeActorTrackId(string actid, string toid)
        {
            if (actid != "")
            {
                // we found this char
        ...
        public virtual void delPropFromTrack(string propid)
        {
            if (propid != "")
            {
                // we found this prop
        ...
        public virtual HSNeoOCIFolder createFld(string txt, HSNeoOCI parent = null, bool ret = true)
        {
        ...
        public virtual HSNeoOCIFolder createFldIfNo(string txt, HSNeoOCIFolder parent, int childNum)
        {
            HSNeoOCIFolder fld;
        ...
        // Parse/Save/Load
        public virtual Dictionary<string, Scene> findAndLoadSceneData(bool backup = false)
        {
            object res;
            object patch;
            object ind;
        ...
        public virtual Dictionary<string, Scene> parseSSSFlds(OCIFolder fld, bool backup = false)
        {
            if (fld.name.StartsWith("-scenesavestate:") && backup == false || fld.name == "-scenesavestatebackup" && backup == true)
            {
                ...
                foreach (TreeNodeObject scene_fld in fld.treeNodeObject.child)
                {
                    ...
                    (string key, object data) = this.parseFlds(sceneFld);
                    dict[key] = (Scene)data;
                }
                return dict;
            }
        ...
        public virtual (string key, object data) parseFlds(HSNeoOCIFolder fld, bool backup = false)
        {
            ...
            if (fld.name.Contains("-scene:"))
            {
                ...
                foreach (var child in fld.treeNodeObject.child)
                {
                    ...
                    (string key, object data) = this.parseFlds(sc_elements);

                    if (key == "actors")
                    {
                        sc_dict.actors = (Dictionary<string, ActorData>)data;
                    } else if (key == "props")
                    {
                        sc_dict.props = (Dictionary<string, PropData>)data;
                    } else if (key == "cams")
                    {
                        sc_dict.cams = (List<CamData>)data;
                    }
                }
                return (fld.name.Substring("-scene:".Length), sc_dict);
            }
            else if (fld.name == "-actors")
            {
                ...
                foreach (var child in fld.treeNodeObject.child) {
                    ...
                    if (chara.name.StartsWith("{"))
                    {
                        ...
                        char_data = JsonSerializer.Deserialize<Dictionary<string, object>>(chara.name);
                    ...
                    else
                    {
                        ...
                        char_data = JsonSerializer.Deserialize<Dictionary<string, object>>(char_fld.name);
                        char_dict[chara.name] = char_data;
                    }
                }
                return (fld.name.Substring("-".Length), char_dict);
            }
            else if (fld.name == "-props")
            {
                ...
                foreach (var child in fld.treeNodeObject.child)
                {
                    ...
                    {
                        prop_data = JsonSerializer.Deserialize<Dictionary<string, object>>(prop_name);
                    ...
                    else
                    {
                        ...
                        prop_data = JsonSerializer.Deserialize<Dictionary<string, object>>(prop_fld.name);
                        prop_dict[prop_name] = prop_data;
                    }
                }
                return (fld.name.Substring("-".Length), prop_dict);
            }
            else if (fld.name == "-cams")
            {
                ...
                //     prop_state = JsonSerializer.Deserialize(state_fld.name, object_hook=sceneDecoder)
                ...
                foreach (var child in fld.treeNodeObject.child)
                {
                    ...
                    (string key, object cam_data) = this.parseFlds(cam);
                    int id = Convert.ToInt32(key);
                    cams_dict[id] = cam_data;
                }
                return (fld.name.Substring("-".Length), cams_dict);
            }
            else if (fld.name.Contains("-cam:"))
            {
                ...
                Dictionary<string, object> cam_state = JsonSerializer.Deserialize<Dictionary<string, object>>(state_fld.name);
                return (key, cam_state);
            } 
            else
            {
        ...
        public virtual void restrict_to_child(HSNeoOCIFolder fld, int numchilds)
        {
        ...
        public virtual void saveSceneData(object param)
        {
        ...
        public virtual void saveSceneData(bool backup = false)
        {
            ...
            foreach (Scene scene in sdict)
            {
                ...
                foreach (var ch_name in scene.actors.Keys)
                {
                    ...
                    if (bestInd == -1)
                    {
                        // no optimization
                        //print "non-opt"
                        //self.createFld(JsonSerializer.Serialize(ch_content, cls=SceneEncoder), ch_name_fld)
                        this.createFldIfNo(JsonSerializer.Serialize(new Dictionary<object, object> {
                            {
                                ch_name,
                    ...
                    {
                        //self.createFld(JsonSerializer.Serialize({'_diff':[bestInd, bestResDiff]}, cls=SceneEncoder), ch_name_fld)
                        this.createFldIfNo(JsonSerializer.Serialize(new Dictionary<object, object> {
                            {
                                ch_name,
                ...
                foreach (var i in Enumerable.Range(0, scene.cams.Count - 0))
                {
                    ...
                    this.createFldIfNo(JsonSerializer.Serialize(scene.cams[i]), cam_id_fld, 0);
                }
                ...
                foreach (var prop_id in scene.props.Keys)
                {
                    ...
                    */
                    if (bestInd == -1)
                    {
                        // no optimization
                        // print "non-opt"
                        //self.createFld(JsonSerializer.Serialize(prop_state, cls=SceneEncoder), prop_id_fld)
                        this.createFldIfNo(JsonSerializer.Serialize(new Dictionary<object, object> {
                            {
                                prop_id,
                    ...
                    {
                        //self.createFld(JsonSerializer.Serialize({'_diff': [bestInd, bestResDiff]}, cls=SceneEncoder), prop_id_fld)
                        this.createFldIfNo(JsonSerializer.Serialize(new Dictionary<object, object> {
                            {
                                prop_id,
                                new Dictionary<object, object> {
        ...
        public virtual int verify_load()
        {
            try
            {
        ...
        public virtual void onDataSaved(VNController game)
        {
            //dt = Time.deltaTime
        ...
        public virtual void saveToFile(object param)
        {
            saveToFile((bool)param);
        }

        public virtual void saveToFile(bool backup = false)
        {
            string filename;
            HSNeoOCIFolder fld;
            // Template
        ...
        public virtual void saveToFileDirect(string filename)
        {
            ...
            new StreamWriter(abs_file_path))
            {
                file.Write(JsonSerializer.Serialize(save_data));
            }
        }

        public virtual Dictionary<string, Scene> loadFromFileDirect(string filename)
        {
            var script_dir = Path.GetDirectoryName(Application.dataPath);
            var folder_path = "sssdata/";
            var file_path = folder_path + filename.ToString() + ".txt";
            ...
            if (File.Exists(abs_file_path))
            {
                ...
                var block_dict = JsonSerializer.Deserialize<Dictionary<string, Scene>>(text);
                return block_dict;
            }
            return null;
        }

        public virtual void loadSceneDataInternalDict(Dictionary<string, Scene> block_dict, bool file)
        {
            if (!(block_dict == null))
            {
                // init zero
        ...
        public virtual void loadSceneDataBackupTimer(object param)
        {
            loadSceneDataBackupTimer();
        }

        public virtual void loadSceneDataBackupTimer()
        {
            var block_dict = this.loadFromFileDirect("_backuptimer");
            this.loadSceneDataInternalDict(block_dict, true);
        }

        public virtual void loadSceneData(object param)
        {
            bool[] bool_params = (bool[])param;
            loadSceneData(bool_params[1], bool_params[2], bool_params[3]);
        }

        public virtual void loadSceneData(bool file = false, bool backup = false, bool setToFirst = true)
        {
            string filename;
            this.game.scenef_register_actorsprops();
            ...
            else
            {
                ...
                //     block_dict = JsonSerializer.Deserialize(f.read(), object_hook=sceneDecoder)  # , indent = 4, separators = (","," : ")))
                //     f.close()
        ...
        // Change name
        public virtual void changeCharName(string name)
        {
        ...
        public virtual void dupScene()
        {
            if (this.block.Count > 0)
            {
                //import copy
                // we have a problem with copy, so... just serialize and back it
                //objstr = JsonSerializer.Serialize(self.block[self.cur_index])
        ...
        // Copy/paste cam set
        public virtual void copyCamSet()
        {
            if (this.cur_index > -1)
            {
        ...
        public virtual void pasteCamSet()
        {
            if (this.cur_index > -1)
            {
        ...
        // Move cam (up/down)
        public virtual void move_cam_up()
        {
        ...
        public virtual void move_cam_down()
        {
        ...
        // Move scene(up/down)
        public virtual void move_scene_up()
        {
            if (this.cur_index > 0)
            {
        ...
        public virtual void move_scene_down()
        {
        ...
        // Goto next/prev
        public virtual void goto_first()
        {
            this.cur_index = 0;
        ...
        public virtual void goto_next_sc()
        {
        ...
        public virtual void goto_prev_sc()
        {
            goto_prev_sc(false);
        }

        public virtual void goto_prev_sc(bool lastcam = false)
        {
        ...
        // export cam texts
        public virtual void exportCamTexts()
        {
...
// var f = codecs.open(filename, "w+", encoding: "utf-8");
                ...
                foreach (var i in Enumerable.Range(0, this.block.Count))
                {
                    ...
                    foreach (var j in Enumerable.Range(0, scene.cams.Count))
                    {
                        ...
                        var res = JsonSerializer.Serialize(fullobj);
        ...
        // export cam texts
        public virtual void importCamTexts()
        {
            var filename = "sss_camtexts.txt";
            try
            {
                string filecont = this.game.file_get_content_utf8(filename);
                var arr = JsonSerializer.Deserialize<List<(int, CamData)>>(filecont);
                foreach ((int scenenum, CamData elem) in arr)
                {
        ...
        public virtual void camSetAll(bool state)
        {
            foreach (var i in Enumerable.Range(0, this.block.Count))
            {
                var scene = this.block[i];
        ...
        public virtual void exportToVNSS()
        {
        ...
        public virtual void runVNSS(string starfrom = "begin")
        {
        ...
        public virtual void endVNSSbtn(VNNeoController game = null)
        {
            //VNSceneScript.run_state(this.game, this.game.scenedata.scMaxState + 1, true); TODO
        }

        public virtual void onEndVNSS(VNController game = null)
        {
